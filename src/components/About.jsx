      ...
      <div className="w-full md:w-10/12">
        ...
        <div className="flex flex-col justify-between md:flex-row md:items-center">
          ...
          <div className="flex flex-col md:w-7/12">
            ...
            Developer, and Trainer. Working in cybersecurity field has altered
            my perspective to prioritize technical understanding above all else:
            in order to effectively hack a computer, it's important to have a
            thorough comprehension of how it works.
